...
int main()
{
  ...
  //cout<<"trapezoidal: "<<trapezoidal(a,b,10000000)<<endl;
  cout<<"monte "<<integrate_monte_carlo(a,b,0,64)<<endl;
  cout<<"bool: "<<boole(0.0,2*M_PI,10000)<<endl;
